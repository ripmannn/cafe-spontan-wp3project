                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    foreach ($pelanggan as $p) {  ?>
                                        <tr>
                                            ...
                                            <td><?= $p['telp'] ?></td>
                                            <td>
                                                <a href="<?= base_url('penjualan/transaksi/' . $p['id_pelanggan']) ?>" class="btn-sm btn-primary">Pilih</a>
                                            </td>
                                        </tr>
                                    <?php $no++;
                                    } ?>
            ...
            <tbody class="table-border-bottom-0">
                ...
                foreach ($penjualan as $p) {  ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('penjualan/invoice/' . $p['kode_penjualan']) ?>" class="btn-sm btn-info">Cek</a>
                        </td>
                    </tr>
